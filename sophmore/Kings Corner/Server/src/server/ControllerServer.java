...
public class ControllerServer implements Initializable {
    ...
    private ServerSocket serverService = null;
    private Socket clientService = null;
    private PrintWriter output;
    private BufferedReader input;
    
    private long seed = (int) System.currentTimeMillis();
        ...
        new Thread(() -> {
            while(serverService == null) {
                try {
                    ...
                    clientService = serverService.accept();
                    ...
                    serverService = null;   // Resets server to nothing if it fails to connect
                    try {
                        Thread.sleep(6000);
                    }
    ...
    private void listener() {
        new Thread(() -> {
            if (serverService.isBound()) {
                System.out.println("Server bound at: " + serverService.getInetAddress().getHostAddress() + ":" + serverService.getLocalPort());
        ...
        Platform.runLater(() -> {
            ...
            //Move stack
                ...
                try {
                    ...
                    allPilesCards.get(NewAllArrayPos).add(allPilesCards.get(allArrayPos).get(arrayPos - 1));
                }
